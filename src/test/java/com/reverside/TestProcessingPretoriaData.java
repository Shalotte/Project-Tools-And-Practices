...
public class TestProcessingPretoriaData {
	...
	private String filename ="sample_pretoria.txt";
	private int id = 400;
	...
	private ProcessingPretoriaData processingPretoriaData = new ProcessingPretoriaData();
	private String output=processingPretoriaData.processingLine2(input);

	
	
@Test
public void testDataCleansingP() throws FileNotFoundException {
	final String output1=processingPretoriaData.dataCleansing(output,id);
